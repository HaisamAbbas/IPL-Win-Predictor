...
cities = ['Hyderabad', 'Banglore', 'Mumbai', 'Indore', 'Kolkata', 'Delhi',
          'Candigarh', 'Jairpur', 'Chennai', 'Cape Town', 'Port Elizabeth',
...
if st.button('Predict Probability'):
    ...
    input_df = pd.DataFrame({'batting_team': [battingteam], 'bowling_team': [bowlingteam], 'city': [city], 'runs_left': [runs_left],
                             'balls_left': [balls_left], 'wickets': [wickets], 'total_run_rate': [currentrunrate]})
